...
frame_no = torch.tensor([1,2,3,1,2,3,1])
...
print("input",tc.model[0].input)
print(tc((input_tensor[:, 2:5], frame_no[2:5], InferenceMode.STORE))[0].T)
print("input",tc.model[0].input)
print(tc((input_tensor[:, 5:6], frame_no[5:6], InferenceMode.STORE))[0].T)
print("input",tc.model[0].input)
print(tc((input_tensor[:, 6:], frame_no[6:], InferenceMode.STORE))[0].T)
print("input",tc.model[0].input)
...
print(ab((input_tensor[:,5:6], frame_no[5:6], InferenceMode.STORE))[0].T)
print(ab((input_tensor[:,6:], frame_no[6:], InferenceMode.STORE))[0].T)
