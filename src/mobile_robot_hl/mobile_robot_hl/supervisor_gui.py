...
class SupervisorGUI():
    ...
    def setup_display_frame(self):
        ...
        image_model = ImageTk.PhotoImage(self.blank_image)
        image_current = ImageTk.PhotoImage(self.blank_image)
        self.image_model_label = tkinter.ttk.Label(self.display_frame,image=image_model)
        self.image_current_label = tkinter.ttk.Label(self.display_frame,image=image_current)
        ...
        self.action_plot_fig = plt.figure(figsize=(3,1))
    ...
    def setup_control_frame(self):
        ...
        self.automatic_start_button = tkinter.ttk.Button(self.automatic_control_frame, text="start")
        ...
        self.demo_start_button = tkinter.ttk.Button(self.demo_control_frame, text="start")
        self.demo_stop_button = tkinter.ttk.Button(self.demo_control_frame, text="stop")
        self.model_start_button = tkinter.ttk.Button(self.model_control_frame, text="start")
    ...
    def update_image_current(self, img_arr):
        image_current = ImageTk.PhotoImage(img_arr)
        self.image_current_label.configure(image=image_current)
