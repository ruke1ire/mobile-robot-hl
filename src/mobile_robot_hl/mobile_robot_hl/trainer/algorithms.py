...
class TD3(Algorithm):
    def __init__(self, 
        ...
        self.run_id = str(run_id) + self.__class__.__name__
        self.checkpoint_path = os.path.join(CHECKPOINT_PATH, self.run_name, self.run_id, self.__class__.__name__, "checkpoint.pth")
        ...
        if(os.path.exists(self.checkpoint_path)):
            ...
            os.makedirs(os.path.join(CHECKPOINT_PATH, self.run_name, self.run_id, self.__class__.__name__), exist_ok=True)
